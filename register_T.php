...
<body class="text-center">
  ...
  <h1 class="display-4">Registrations for Teachers</h1>
  <p class="lead">This is the Form of Registrations for Teachers of CAI in the Univerity Polytechnic of Victoria.</p>
  </div>  
